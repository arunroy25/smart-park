...
public class ReportingEntryRecyclerAdapter extends RecyclerView.Adapter<ReportingEntryRecyclerAdapter.ViewHolder> {
    ...
    ReportingEntryRecyclerAdapter(Context context, List<ParkingReport> dbList, deleteListener listener) {
        this.dbList = new ArrayList<ParkingReport>();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.reporting_entry_item, null);
        // create ViewHolder
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                helper.deleteParkingReporting(dbList.get(position).getReportingId());
